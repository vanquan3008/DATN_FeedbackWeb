                    ...
                    <div className="flex flex-col mb-8 ">
                        ...
                        <div className=" ">
                            ...
                            >
                                ...
                                <span className="text-base font-medium mt-1.5 mb-1.5">Dashboard</span>
                            </a>
                            <a className={`flex flex-row p-1.5 w-auto hover:bg-sky-200
                            ...
                            >
                                ...
                                <span className=" text-base font-medium mt-1.5 mb-1.5">History</span>
                            </a>
                            ...
                            text-center  items-center rounded-2xl`} >
                                ...
                                <span className="text-base font-medium mt-1.5 mb-1.5">FeedBack</span>
                            </a>

                            <a href="/InputURL" className={`flex flex-row p-1.5 w-auto  hover:bg-sky-200
                            ...
                            text-center  items-center rounded-2xl`} >
                               <div className="my-2 ml-1.5 mr-3 w-8 h-8 flex justify-center items-center rounded-lg shadow drop-shadow-lg bg-white">
                                ...
                                <span className="text-base font-medium mt-1.5 mb-1.5">Input URL</span>
                            </a>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div>
                            <a href="/profile"  className={`flex flex-row p-1.5 w-auto  text-center hover:bg-sky-200
                                ...
                                <span className="text-base font-medium mt-1.5 mb-1.5">Profile</span>
                            </a>
                            {/* Logout */}
                            ...
                            `}  onClick={handleLogout}>
                                ...
                                <span className="text-base font-medium mt-1.5 mb-1.5">Logout</span>
                            </div>
                            {/* Login and Register */}
                            ...
                            `}>
                                ...
                                <span className="text-base font-medium mt-1.5 mb-1.5">Sign In</span>
                            </a>
                            <a href="/register" className={`flex flex-row p-1.5 w-auto  text-center hover:bg-sky-200  items-center rounded-2xl
                                        ${userLogin ? 'hidden':''}
                            `}>
                                <img alt="" className="mt-2 mr-2" src={icons.iconSignUpPage}></img>
                                <span className="text-base font-medium mt-1.5 mb-1.5">Sign Up</span>
                            </a>
