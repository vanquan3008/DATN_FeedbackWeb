export const icons ={
    ...
    iconTablePage : require('./iconTablePage.svg').default,

    iconProfileLogin : require('./iconProfileLogin.svg').default,
    iconProfileRgt : require('./iconProfileRgt.svg').default,
    iconProfilePage : require('./iconProfilePage.svg').default,
    iconProfileSignUp : require('./iconProfileSignUp.svg').default,

    iconSignInLogin : require('./iconSignInLogin.svg').default,
    iconSignInRgt : require('./iconSignInRgt.svg').default,
    iconSignInPage :require('./iconSignInPage.svg').default,
