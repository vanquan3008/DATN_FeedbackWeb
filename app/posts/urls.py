...
urlpatterns = [
    ...
    path("json_detail_analysis", views.analyze_json_detail_sentiment_file),
    path("csv_analysis", views.analyze_csv_file),
    path("csv_detail_analysis", views.analyze_csv_detail_sentiment_file),
    path("text_analysis", views.analyze_text),
    path("txt_analysis", views.analyze_txt_file),
    path("txt_detail_analysis", views.analyze_txt_detail_sentiment_file),
