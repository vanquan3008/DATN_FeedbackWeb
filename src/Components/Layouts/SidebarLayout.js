            ...
            <div className="pl-8 pr-8">
                    ...
                    <div className="flex flex-col mb-8 ">
                        ...
                        <div>
                            ...
                            <a href="/" className="flex flex-row p-1.5 w-auto   text-center  items-center rounded-2xl" >
                                <img alt="" className="mt-2 mr-2" src={icons.iconTablePage}></img>
                                <span className="text-sm mt-1.5 mb-1.5">Table</span>
                            </a>
                        </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div>
                            <a href="/profile"  className={`flex flex-row p-1.5 w-auto  text-center 
                            ...
                            <a href="/profile" className="flex flex-row p-1.5 w-auto  text-center  items-center rounded-2xl">
